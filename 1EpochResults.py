...
x = np.arange(2,11)
mixtureOfExperts = np.load("MixtureOfExperts/1epochtestresults/mixtureOfExpertsResultsAccuracy.npy")
...
x = np.arange(2,11)
ensembleMethod = np.load("EnsembleMethod/1epochtestresults/ensembleMethodResultsAccuracy.npy")
...
x = np.arange(2,11)
ensembleMethod = np.load("EnsembleMethod/1epochtestresults/normalMethodResultsAccuracy.npy")
...
x = np.arange(2,11)
ensembleMethod = np.load("EnsembleMethod/1epochtestresults/ensembleMethodResultsTime.npy")
...
x = np.arange(2,11)
mixtureOfExperts = np.load("MixtureOfExperts/1epochtestresults/mixtureOfExpertsResultsTime.npy")
...
x = np.arange(2,11)
ensembleMethod = np.load("EnsembleMethod/1epochtestresults/normalMethodResultsTime.npy")
